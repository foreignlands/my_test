...
: ${AMENT_CURRENT_PREFIX:="/home/step-len02/my_test/install/server"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/server/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/server/environment/path.sh"
